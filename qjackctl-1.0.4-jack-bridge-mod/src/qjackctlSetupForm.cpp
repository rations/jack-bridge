...
//	m_ui.SelfConnectModeComboBox->setEnabled(bJackDBus);
	...
	m_ui.NoMemLockCheckBox->setEnabled(!bCoreaudio && !(bJackDBus && QDBusConnection::sessionBus().isConnected()));
	m_ui.UnlockMemCheckBox->setEnabled(!bCoreaudio && !(bJackDBus && QDBusConnection::sessionBus().isConnected())
	...
	m_ui.IgnoreHWCheckBox->setEnabled((bSun || bOss) && !(bJackDBus && QDBusConnection::sessionBus().isConnected()));
	...
	m_ui.WordLengthTextLabel->setEnabled((bSun || bOss) && !(bJackDBus && QDBusConnection::sessionBus().isConnected()));
	m_ui.WordLengthComboBox->setEnabled((bSun || bOss) && !(bJackDBus && QDBusConnection::sessionBus().isConnected()));
	...
	m_ui.ServerNameTextLabel->setEnabled(!(bJackDBus && QDBusConnection::sessionBus().isConnected()));
	m_ui.ServerNameComboBox->setEnabled(!(bJackDBus && QDBusConnection::sessionBus().isConnected()));
	m_ui.ServerPrefixTextLabel->setEnabled(!(bJackDBus && QDBusConnection::sessionBus().isConnected()));
	m_ui.ServerPrefixComboBox->setEnabled(!(bJackDBus && QDBusConnection::sessionBus().isConnected()));
	m_ui.ServerSuffixTextLabel->setEnabled(!(bJackDBus && QDBusConnection::sessionBus().isConnected()));
	m_ui.ServerSuffixComboBox->setEnabled(!(bJackDBus && QDBusConnection::sessionBus().isConnected()));
