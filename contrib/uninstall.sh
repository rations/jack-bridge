...
echo "  sudo apt remove --purge jackd2 qjackctl bluez bluez-tools \\"
echo "    libasound2-plugins alsa-utils apulse libasound2-plugin-equal \\"
echo "    swh-plugins libgtk-3-0"
