### KNOWN ISSUES. PLUG YOUR USB AUDIO INTERFACE IN AFTER BOOT. MIDI DEVICES (DRUMS, KEYBOARDS etc) SHOULD BE POWERED ON AFTER BOOT. If your usb interface is plugged in during boot or midi devices are powered they will override jack-bridge. Pressing setup in the qjackctl GUI tends to crash unless you have opened graph or messages first.
