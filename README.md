...
### Know issue. If using an external usb audio interface or any usb midi hardware (drums, keyboards etc) they can override jack-bridge if plugged in on boot. If this happens plug them in after booting. 
